...
public class Car implements Serializable, Cloneable {
    ...
    public void setCarCurrency(CarCurrency carCurrency) {
        switch (carCurrency) {
            case EUR:
                this.carCurrency = Currency.getInstance("EUR");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case CZK:
                this.carCurrency = Currency.getInstance("CZK");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case USD:
                this.carCurrency = Currency.getInstance("USD");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case PLN:
                this.carCurrency = Currency.getInstance("PLN");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case GBP:
                this.carCurrency = Currency.getInstance("GBP");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case INR:
                this.carCurrency = Currency.getInstance("INR");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case AUD:
                this.carCurrency = Currency.getInstance("AUD");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case CAD:
                this.carCurrency = Currency.getInstance("CAD");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case SGD:
                this.carCurrency = Currency.getInstance("SGD");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case CHF:
                this.carCurrency = Currency.getInstance("CHF");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case MYR:
                this.carCurrency = Currency.getInstance("MYR");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case JPY:
                this.carCurrency = Currency.getInstance("JPY");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
            case CNY:
                this.carCurrency = Currency.getInstance("CNY");
                //this.locale = getLocale(this.carCurrency.getCurrencyCode());
                break;
        }
    }
